...
namespace MailSender.Raport
{
    public class RecipientsRaport
    {
        public struct WordRaport
        {
            public string Name { get; set; }
            public string Address { get; set; }
        }
        public IEnumerable<WordRaport> Recipients { get; set; }
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "142";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "007B6695", RsidParagraphProperties = "00C72FD8", RsidRunAdditionDefault = "00BF3284" };
            ...
            Run run1 = new Run();
            Text text1 = new Text();
            text1.Text = "Отчет о существующих адресатах";

            run1.Append(text1);

            paragraph1.Append(paragraphProperties1);
            paragraph1.Append(run1);
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00C72FD8", RsidParagraphAddition = "00C72FD8", RsidParagraphProperties = "00C72FD8", RsidRunAdditionDefault = "00C72FD8" };


            Paragraph paragraph6 = new Paragraph() { RsidParagraphMarkRevision = "00BF3284", RsidParagraphAddition = "00BF3284", RsidRunAdditionDefault = "00BF3284" };
            ...
            text13.Text = Recipients.Count().ToString();
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00BF3284", RsidR = "00BF3284" };
            ...
            {
                var one = GetParagraph(recipient);
                body1.Append(one);
            }
        ...
        /// <summary> Параграф с данными по получателю </summary>
        private static Paragraph GetParagraph(WordRaport recipient)
        {


            Paragraph paragraph3 = new Paragraph()
            {
                RsidParagraphMarkRevision = "00D85A9A", RsidParagraphAddition = "00BF3284",
                RsidParagraphProperties = "00C72FD8", RsidRunAdditionDefault = "00C72FD8"
            };
            ...
            Text text2 = new Text();
            text2.Text = recipient.Name;

            run2.Append(runProperties1);
            run2.Append(text2);

            Run run3 = new Run() {RsidRunAddition = "0099211F"};
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00304BBC" };
            Rsid rsid1 = new Rsid() { Val = "00037CA3" };
            Rsid rsid2 = new Rsid() { Val = "00080F06" };
            Rsid rsid3 = new Rsid() { Val = "00304BBC" };
            Rsid rsid4 = new Rsid() { Val = "0099211F" };
            Rsid rsid5 = new Rsid() { Val = "00BF3284" };
            Rsid rsid6 = new Rsid() { Val = "00C72FD8" };
            Rsid rsid7 = new Rsid() { Val = "00D85A9A" };
            Rsid rsid8 = new Rsid() { Val = "00EB3DDA" };
            ...
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{79199E3F-5505-4DED-A6B6-0A862E3D3B5A}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Rsid rsid9 = new Rsid() { Val = "00C72FD8" };
            ...
            Rsid rsid10 = new Rsid() { Val = "00C72FD8" };
            ...
            Rsid rsid11 = new Rsid() { Val = "00C72FD8" };
        ...
        private void GenerateNumberingDefinitionsPart1Content(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            ...
            Nsid nsid1 = new Nsid() { Val = "151C158B" };
            MultiLevelType multiLevelType1 = new MultiLevelType() { Val = MultiLevelValues.HybridMultilevel };
            TemplateCode templateCode1 = new TemplateCode() { Val = "1A50BD7A" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2021-03-12T19:37:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2021-03-12T19:42:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
